...
import { ProjectMobileSidebar } from '../../components/Projects/ProjectSidebar/index';
import { atom, Provider } from 'jotai';

export const isMobileProjectSidebarOpenAtom = atom(false);
...
export default function ComponentPreview() {
  ...
  return (
    <Provider>
      <ProjectMobileSidebar project={state.project.value} />
    </Provider>
  );
}